    ...
    >
      ...
      {currentUser?.email === 'quxbashop@gmail.com' && onDeleteProduct && (
        <button
          ...
          className="absolute top-2.5 left-2.5 bg-red-50 hover:bg-red-600 hover:text-white text-red-600 p-1.5 rounded-full z-25 shadow-md border border-red-200 transition-all duration-250 active:scale-90 cursor-pointer hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-400"
